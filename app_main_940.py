...
with tab1:
    ...
    #'RestingECG'
    x7 = st.radio("RestingECG",encoder.RestingECG.classes_)
    ...
    #'ExerciseAngina'
    x9 = st.radio("ExerciseAngina",encoder.ExerciseAngina.classes_)
    x9 = ExerciseAngina_encoder.transform([x9])[0]

    #'Oldpeak'
    x10 = st.slider('Oldpeak', 0, 1.5, 3)

    #'ST_Slope'
    x11 = st.radio("ST_Slope",encoder.ST_Slope.classes_)
